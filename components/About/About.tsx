      ...
      <div id='about' className='bg-[#121121] pt-[4rem] pb-[4rem] md:pt-[4rem]'>
          ...
          <div data-aos="fade-right" data-aos-delay="300" className='grid grid-cols-1 1150:grid-cols-2 w-[80%] 1150:w-[90%] mx-auto gap-[3rem] lg:justify-start justify-center items-center'>
              <div className='flex items-center mx-auto 1150:mx-0 justify-center 1150:justify-start flex-col'>
                  ...
                  <p className='text-[20px] text-slate-300 w-[80%] 1150:w-[90%]'>
                  ...
                  <div className='space-y-6 mt-[2rem] flex-col sm:space-y-0 sm:space-x-6 sm:flex sm:flex-row sm:items-center'>
                      <a href='images/Sarthak_Resume.pdf'
                          ...
                          target='_blank'
                          className='px-[1.5rem] hover:bg-orange-400 transition-all duration-200 py-[1rem] text-[20px] font-bold
                              flex text-black bg-blue-200 gap-2'>
                           Download CV
